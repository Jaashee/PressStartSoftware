                    ...
                    <div>
                        <form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="<?php $employee_id ?>" name="employee_id"
                                       id="gametitle"
                                       placeholder="Enter Employee who assisted" type="number">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="<?php $console ?>" name="console"
                                       placeholder="Enter console name" type="text">
                            </div>
                            <div class="form-group">
                                <label for="price">Price:</label>
                                <input class="form-control" value="<?php $employee_id ?>" name="price"
                                       placeholder="Enter price of repair" type="number" step="any">
                            </div>
                            <div class="form-group">
                                <label for="productid">Product ID:</label>
                                <input class="form-control" value="<?php $prodid ?>" name="productid"
                                       placeholder="Enter sequence of numbers" type="number">
                            </div>
